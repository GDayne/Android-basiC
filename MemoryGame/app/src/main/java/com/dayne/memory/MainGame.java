...
public class MainGame extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        TextView url = ((TextView)findViewById(R.id.start));
        Linkify.addLinks(url, Linkify.WEB_URLS);
        
       backCard =  getResources().getDrawable(R.drawable.icon);
       ...
       buttonListener = new ButtonListener();
        ...
        context  = mainTable.getContext();
       	 ...
       	 Spinner s = (Spinner) findViewById(R.id.newGameSpinner);
	        ...
	        s.setOnItemSelectedListener(new OnItemSelectedListener(){
	    	  ...
	    	  public void onItemSelected(
	    		  ...
	    		  ((Spinner) findViewById(R.id.newGameSpinner)).setSelection(0);
    	...
    	public void handleMessage(Message msg) {
    	 ...
    	 public void checkCards(){
    	    	if(cards[secondCard.x][secondCard.y] == cards[firstCard.x][firstCard.y]){
    				...
    				secondCard.button.setBackgroundDrawable(backCard);
    				firstCard.button.setBackgroundDrawable(backCard);
    			}
